...
const Store = () => {
    return (
        <div style={{ backgroundImage: "url(\"https://image.freepik.com/free-vector/hand-drawn-minimal-background_23-2149017007.jpg" }} 
                      className="w-screen h-screen bg-cover border-1 rounded-md bg-repeat-y bg-center">
